...
export class Client extends EventEmitter {
  ...
  on(
    ...
    listener: (error: Error, metrics: any) => void
  ): this;
  // event messages
  ...
  on(
    ...
    listener: (error: Error, report: any) => void
  ): this;

  // offsets
  on(
    event: 'offset.commit',
    listener: (error: Error, topicPartitions: any[]) => void
  ): this;
  ...
  once(
    event: 'rebalance',
    listener: (err: Error, assignment: any) => void
  ): this;
...
export class KafkaConsumer extends Client {
  ...
  committed(
    toppars: any,
    timeout: any,
    cb: (err: any, topicPartitions: any) => void,
    ...args: any[]
  ): ErrorWrap<any>;
